...
<header class="absolute inset-y-10 left-10 h-2 text-white tracking-widest header">Hackathon<sup class="ml-2">TCSC</sup>
</header>

<body class="mainbody flex items-center justify-center min-h-screen bg-no-repeat bg-cover">
    <div
        class="bg-white p-12 rounded-lg w-full max-w-md login_layout border-solid border-2 border-sky-500 login_layout_fade">
        ...
        <form id="login-form" action="{{ url('/testlogin') }}" method="POST" class="space-y-6">
            ...
            <!-- Leader Name Field -->
            <div>
                <label for="leader_name" class="block text-white font-semibold mb-2"><i
                        class="fa-regular fa-user"></i>&nbsp;&nbsp;&nbsp;Leader Name</label>
            ...
            <!-- Group ID Field -->
            <div>
                <label for="group_id" class="block text-white font-semibold mb-2"><i
                        class="fa-solid fa-id-card"></i>&nbsp;&nbsp;&nbsp;Group ID</label>
            ...
            <div>
                <button type="submit"
                    ...
                    <i class="fa-solid fa-right-to-bracket mr-2"></i> Start Test
                </button>
            </div>
        </form>
    </div>
